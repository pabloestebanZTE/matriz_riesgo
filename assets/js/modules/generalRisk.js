    ...
    var ini = {
        ...
        getButtons: function (obj) {
            return '<div class="btn-group">'
                    + '<a href="' + app.urlTo('Risk/findRiskById?idRiesgo=' + obj.k_id) + '" class="btn btn-default btn-xs" data-toggle="tooltip" title="Editar Riesgo"><span class="fa fa-fw fa-pencil-square-o"></span></a>'
                    + '<a href="' + app.urlTo('Risk/duplicarRiesgo?idRiesgo=' + obj.k_id) + '" class="btn btn-default btn-xs" data-toggle="tooltip" title="Duplicar"><span class="fa fa-fw fa-copy"></span></a>'
                    + '</div>';
        },
