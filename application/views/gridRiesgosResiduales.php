    ...
    <body data-base="<?= URL::base() ?>" class="bg-gray">
        ...
        <div class="container">
            <nav class="breadcrumb m-t-15 m-b-1">
                ...
                <span class="breadcrumb-item active">Mapa de Riesgos Residuales</span>
            </nav>
                ...
                <div class="col-md-9 bg-white p-t-15">
                    <table class="display-block" width="100%" >
                        <tr>
                            ...
                            <td style="border: 0px; height: 30px; min-height: 30px;" colspan="5" class="text-center text-bold"> Mapa de Riesgos Residuales</td>
                            <td class="item-border"></td>
                        </tr>
                        <tr>
        ...
        <script type="text/javascript" src="<?= URL::to("assets/js/modules/mapa_riesgos_residuales.js?v=" . time()); ?>"></script>
        <!-- CUSTOM SCRIPT   -->
    </body>
</html>